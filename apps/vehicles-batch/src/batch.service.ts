...
import { Member } from 'apps/vehicles-api/src/libs/dto/member/member';
import { Property } from 'apps/vehicles-api/src/libs/dto/property/property';
import { MemberStatus, MemberType } from 'apps/vehicles-api/src/libs/enums/member.enum';
import { PropertyStatus } from 'apps/vehicles-api/src/libs/enums/property.enum';
...
export class BatchService {
	...
	public getHello(): string {
		return 'Welcome to vehicles BATCH Server!';
	}
}
